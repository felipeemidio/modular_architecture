...
class _BerriesListPageState extends State<BerriesListPage> {
  ...
  _loadNextPage() async {
    ...
    isLoading = true;
    final fetchedPokemons = await berryRepository.getAll(page: page, size: size);
              ...
              builder: (context) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    return ListTile(
                      onTap: () => Modular.to.pushNamed('/home/berries/detail', arguments: currentBerry, forRoot: true),
                      leading: Image.network(currentBerry.spriteUrl),
                      title: Text(currentBerry.name),
                      trailing: IconButton(
                        icon: currentBerry.favorite ? const Icon(
                          Icons.favorite,
                          color: Colors.orange,
                        ) : const Icon(
